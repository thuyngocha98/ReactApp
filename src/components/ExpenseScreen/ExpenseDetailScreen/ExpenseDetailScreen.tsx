        ...
        return (
            <View style={ExpenseDetailScreenStyles.container}>
                ...
                <View style={ExpenseDetailScreenStyles.header}>
                    <Text style={ExpenseDetailScreenStyles.txtHeader}>
                    ...
                    <View style={ExpenseDetailScreenStyles.listItem}>
                        ...
                        >
                            <View style={ExpenseDetailScreenStyles.listItemDetail}>
                                ...
                                <View style={ExpenseDetailScreenStyles.content}>
                                    <Text style={ExpenseDetailScreenStyles.txt1}>
                                        You paid, split equally.
                            </Text>
                                    <Text style={ExpenseDetailScreenStyles.txt2}>
                                        Ha owes you 2.612.00 US$.
                            </Text>
                                </View>
                        ...
                        >
                            <View style={ExpenseDetailScreenStyles.listItemDetail}>
                                ...
                                <View style={ExpenseDetailScreenStyles.content}>
                                    <Text style={ExpenseDetailScreenStyles.txt1}>
                                        Trung paid, split equally.
                            </Text>
                                    <Text style={ExpenseDetailScreenStyles.txt3}>
                                        You owes trung 2.612.00 US$.
                            </Text>
                                </View>
                        ...
                        >
                            <View style={ExpenseDetailScreenStyles.listItemDetail}>
                                ...
                                <View style={ExpenseDetailScreenStyles.content}>
                                    <Text style={ExpenseDetailScreenStyles.txt1}>
                                        Trung is owed the full amount.
                            </Text>
                                    <Text style={ExpenseDetailScreenStyles.txt3}>
                                        You owes trung 5.224.00 US$.
                            </Text>
                                </View>
