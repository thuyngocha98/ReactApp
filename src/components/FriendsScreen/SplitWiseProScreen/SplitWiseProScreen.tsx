          ...
          <View style={{ alignItems: 'center' }}>
            ...
            <View>
              <TouchableOpacity activeOpacity={0.5} style={styles.payment}>
                <Text style={{ color: '#fff', fontSize: 18, fontWeight: 'bold' }}>VND35000/month</Text>
              </TouchableOpacity>
              <Text style={styles.or}> or </Text>
              <TouchableOpacity activeOpacity={0.5} style={styles.payment}>
                <Text style={{ color: '#fff', fontSize: 18, fontWeight: 'bold' }}>VND349000/year</Text>
              </TouchableOpacity>
            </View>
            <View>
            ...
            <View style={{ paddingHorizontal: 30, marginBottom: 100 }}>
              <Text style={{ textAlign: 'left' }}>
                Recurring billing, cancel anytime. Your subscription will be immediately charged to your iTunes account,
                and auto-renews unless disabled 24 hours before the end of the billing cycle. You can manage your
                subscription by going to iTunes Account Settings.
              </Text>
