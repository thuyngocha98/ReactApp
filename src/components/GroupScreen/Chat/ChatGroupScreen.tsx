...
import {Text, TouchableOpacity, View, TextInput, ScrollView, Image, Slider} from 'react-native';
...
class ChatGroupScreen extends Component<Props, States> {
    ...
    render() {
        console.log(this.state.isMicrophone);
        ...
        const messages = this.state.chatMessages.map((message, i) =>
            message.user_id_sender._id === this.props.user._id ? (
                ...
                >
                    <View style={{flex: 0.3}}/>
                    <View
                        style={{flex: 0.7, flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-end'}}>
                        <View
                            style={{borderRadius: 15, backgroundColor: 'rgba(247,189,66,1)', flexDirection: 'column'}}>
                            <Text style={{
                                textAlign: 'right',
                                color: '#FFFFFF',
                                marginTop: 4,
                ...
                >
                    <View
                        style={{flex: 0.7, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'flex-end'}}>
                        <View style={{marginRight: 3, width: 30, height: 30, borderRadius: 15, overflow: 'hidden'}}>
                            <Image source={thumbnail} style={{width: 30, height: 30}}/>
                        </View>
